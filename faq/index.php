        ...
        <div class="container">
            ...
            ?>
                        ...
                        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                            <ul class="nav navbar-nav">
                                <li>
                                    <a href="/../Car_Rental-PHP/index.php">Home</a>
                                </li>
                                <li>
                                    <a href="/../Car_Rental-PHP/clientlogin.php">Employee</a>
                                </li>
                                <li>
                                    <a href="/../Car_Rental-PHP/customerlogin.php">Customer</a>
                                </li>
                                <li>
        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Yes, we charge PHP500/- day after the due date.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
            </ul>
            ...
            <ul id="chauffeur" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Car Rentals gladly accepts MasterCard, Visa, and checks. We also accept GCASH.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
