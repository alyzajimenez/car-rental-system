...
<style>
    .custom-navbar {
        ...
        width: 100%; /* Set the width to 100% for a full-width navbar */
        length: 100%
    }

    .custom-navbar .navbar-nav > li > a {
        color: white; /* Set the text color for navbar links */
    }
</style>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h1 class="brand-heading" style="color: black; font-weight: bold;">TURBO TRAVELS</h1>
                        <p class="intro-text" style="color: black; font-weight: bold;">
...
<br>
        <section class="menu-content">
            ...
            <h6><b> Automatic transmission Fare: </b><?php echo ("PHP " . $ac_price . "/km & PHP" . $ac_price_per_day . "/day"); ?></h6>
            <h6><b> Manual transmission Fare: </b><?php echo ("PHP " . $non_ac_price . "/km & PHP" . $non_ac_price_per_day . "/day"); ?></h6>
