...
?>
    ...
    <div class="jumbotron" style="color: #3498db;"> <!-- Replace #3498db with your desired color code -->
    <h1 class="text-center">Car Rentals - Customer Panel</h1>
    <br>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" id="customer_username" type="text" name="customer_email" placeholder="Email" required="" autofocus="">
