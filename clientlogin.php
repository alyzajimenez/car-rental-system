...
?>
    ...
    <h1 class="text-center">Car Rentals - Employee Panel</h1>
    <br>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" id="client_Email" type="text" name="client_email" placeholder="Email" required="" autofocus="">
