    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="ac_price" name="ac_price" placeholder="Automatic transmission Fare per KM (PHP)" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="non_ac_price" name="non_ac_price" placeholder="Manual transmission Fare per KM (PHP)" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="ac_price_per_day" name="ac_price_per_day" placeholder="Automatic transmission per day (PHP)" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="non_ac_price_per_day" name="non_ac_price_per_day" placeholder="Manual transmission Fare per day (PHP)" required>
          </div>
  ...
  <table class="table table-striped">
    <thead class="thead-dark">
      <tr>
        ...
        <th width="13%"> Automatic transmission Fare (/km) </th>
        <th width="17%"> Manual transmission Fare (/km)</th>
        <th width="13%"> Automatic transmission Fare (/day)</th>
        <th width="17%"> Manual transmission Fare (/day)</th>
